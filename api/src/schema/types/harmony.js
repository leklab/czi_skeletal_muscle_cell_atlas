...
import shapeHarmony from '../datasets/shapeHarmony'

export const HarmonyType = new GraphQLObjectType({
  name: 'harmonyData',
  fields: {
...
export const fetchHarmonyDetails = async (ctx) => {
  ...
  const data = hits.map(shapeHarmony())
  console.log(data)
